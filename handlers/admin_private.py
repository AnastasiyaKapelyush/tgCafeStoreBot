#Админка для управления БД товаров
...
async def admin_features(message: types.Message):
    await message.answer("Что хотите сделать?", reply_markup=reply.admin_kb)


@admin_router.message(F.text == "Просто посмотреть")
...
async def add_image(message: types.Message, state: FSMContext):
    ...
    await message.answer("Товар добавлен", reply_markup=reply.admin_kb)
